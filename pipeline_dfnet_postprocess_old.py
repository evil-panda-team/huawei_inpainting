...
test_path_dataset = './dataset/test/'
...
for k,v in tqdm(dic.items()):
    ...
    #Postprocessing
    img_blurred = cv2.fastNlMeansDenoisingColored(img_blurred, None, 6, 6, 19, 99)
    ...
    cv2.imwrite("output/dfnet/result_denoising/{}".format(k), img)
